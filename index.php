  ...
  <body>
    ...
    <!--
      <div class="navigation">
        ...
        <a href="/" class="logo"><h1>SM Art</h1></a>
            ...
            <li class="glide__slide">
              <div class="center">
                <div class="left">
                  ...
                  <h1 class=""> SM Art Gallery</h1>
                  <p>Trending from men's and women's  style collection</p>
                  <a href="#" class="hero-btn">SHOP NOW</a>
                </div>
                <div class="right">
                    <img class="img1" src="./images/Couple_lotus.jpg" alt="">
                </div>
              </div>
            </li>
            <li class="glide__slide">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100 h-50" src="./images/Slider_images/slider1.jpeg" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100 h-50" src="./images/Slider_images/slider2.jpeg" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100 h-50" src="./images/Slider_images/slider3.jpeg" alt="Third slide">
      </div>
    </div>
    ...
    <section class="section new-arrival">
      ...
      <div class="product-center">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/Abstract-6.jpg" alt="" />
            </a>
          </div>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/Abstract-8.jpg" alt="" />
            </a>
          </div>
          <div class="product-info">
    ...
    <section class="section new-arrival">
      ...
      <?php
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/Porrote.jpg" alt="" />
            </a>
    ...
    <section class="section new-arrival">
      ...
      <div class="product-center">
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="./images/composition-1.jpg" alt="" />
            </a>
            <span class="discount">50%</span>
          </div>
          <div class="product-info">
